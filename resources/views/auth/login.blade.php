						...
						<div class="login-signin">
							...
							<form class="form"  action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8 @error('email') is-invalid @enderror" type="email" placeholder="Email" name="email"  />
								</div>
								<div class="form-group">
								...
								<div class="form-group text-center mt-10">
									<button  class="btn btn-pill btn-primary opacity-90 px-15 py-3" type="submit">{{ __('Login') }}</button>
								</div>
							</form>
							<div class="mt-10">
