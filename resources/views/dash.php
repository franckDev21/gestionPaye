												...
												<div class="card-spacer mt-n25">
													...
													<div class="row m-0">
														<div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
															<span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2" style="text-align:center;">
...
<g>
	...
	<path style="fill:#FFCD00;" d="M232.5,213.76c-24.762,6.63-43.053,29.253-43.053,56.078c0,27.442,14.402,47.104,40.553,55.365
		...
		c0,9.954-5.216,18.708-13.053,23.688v-47.784C271.568,340.775,275.553,348.29,275.553,360.163z"/>
															...
															<a href="/caisse" class="text-warning font-weight-bold font-size-h6 mr-4">Montant Caisse</a>
															<span class="text-dark-75 font-weight-bolder font-size-h3">{{$caisse}} FCFA</span>
														</div>
														<div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
															<span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2" style="text-align:center;">
															...
															<a href="/employes" class="text-primary font-weight-bold font-size-h6 mt-2 mr-8">Total Employés</a>
														    <span class="text-dark-75 font-weight-bolder font-size-h3 text-right">{{$employe}}</span>
														</div>
													</div>
													<!--end::Row-->
													<!--begin::Row-->
            ...
            $table->foreign('id')->references('id')->on('employe');
            ...
            DB::transaction(function() use($employe)
        {
            ...
            $employe->prime1 = $caisse->montant;
            $caisse->save();
        });


        $table->string('matricule');
            $table->foreign('matricule')->references('matricule')->on('employe');
            $table->integer('prime1');
            $table->integer('prime2');
            $table->integer('prime3');